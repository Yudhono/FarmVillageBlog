...
@section('main-content')
	...
	<div class="row">
		...
		<div class="col-md-8">
			...
			{{ Form::text('e_mail', null, ["class" => 'form-control input-lg']) }}

			{{ Form::label('phone_number', 'Phone Number:') }}
			{{ Form::text('phone_number', null, ["class" => 'form-control input-lg']) }}

			{{ Form::label('body', "Messages:", ['class' => 'form-spacing-top']) }}
		...
		<div class="col-md-4">
			<div class="well">
				...
				<div class="row">
					<div class="col-sm-6">
						{!! Html::linkRoute('contacts.show', 'Cancel', array($contact->id), array('class' => 'btn btn-danger btn-block')) !!}
					</div>
					<div class="col-sm-6">
