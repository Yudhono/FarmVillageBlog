...
@extends('layouts.layout_typo')

@section('content')
<!-- banner section -->
<div class="pogoSlider" id="js-main-slider">
	<div class="pogoSlider-slide" data-transition="barRevealDown" data-duration="1000"  style="background-image:url(frontend/images/banner1-1.jpg);">
		<div class="pogoSlider-slide-element">
			<h3>Check Our Typography</h3>
		</div>
	</div>
	<div class="pogoSlider-slide" data-transition="blocksReveal" data-duration="1000" style="background-image:url(frontend/images/banner2-2.jpg);">
		<div class="pogoSlider-slide-element">
			<h3>Check Our Typography</h3>
		</div>
	</div>
	<div class="pogoSlider-slide" data-transition="barRevealDown" data-duration="1000" style="background-image:url(frontend/images/banner3-3.jpg);">
		<div class="pogoSlider-slide-element">
			<h3>Check Our Typography</h3>
		</div>
	</div>
	<div class="pogoSlider-slide" data-transition="blocksReveal" data-duration="1000"  style="background-image:url(frontend/images/banner4-4.jpg);">
		<div class="pogoSlider-slide-element">
			<h3>Check Our Typography</h3>
		</div>
	</div>
